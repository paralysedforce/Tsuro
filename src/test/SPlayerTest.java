...
public class SPlayerTest {
    ...
    public void drawFromPileDoesntDrawWithFullHandTest() {
        ...
        SPlayer testSPlayer = new SPlayer("Keith", new BoardSpace(0, 0), 0, tilePileMock);
    ...
    public void hasTileReturnsTrueWithEqualTile() {
        ...
        Assert.assertTrue(testSPlayer.hasTile(testTile));
    ...
    public void hasTileReturnsFalseWithoutTile() {
        ...
        Assert.assertFalse(testSPlayer.hasTile(testTile));
    }
}
